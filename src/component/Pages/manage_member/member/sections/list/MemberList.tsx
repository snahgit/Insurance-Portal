...
import { ActionIcon, Badge, Card, Group, Table, Text, Tooltip, Box, Menu, Avatar, Grid, Paper } from "@mantine/core";
import { IconDetails, IconDots, IconInfoCircle, IconPhone, IconStatusChange } from "@tabler/icons-react";
...
import { MemberQuickView } from "../detail/MemberQuickView";
...
export const MemberList = (props: { dataPass: any }) => {
  ...
  const handleModal = async (data: any) => {
    ...
    if (resp == true) {
      const originalAddAction = () => {
        // Special handling for reactivation: status will be set to "Pending" 
        // and the whole process will start fresh from pending
    ...
    <Fragment>
      {/* <PageModal
        ...
        dataPass={{
          ...
          component: <StaffMemberPinForm dataPass={{ if: "1", snahId: 'SNAH236589', name: "John Doe" }} />,
      ...
      <PageDrawer
        ...
        dataPass={{
          ...
          component: <MemberQuickView dataPass={{ staffMemberInfo }} />,
          title: 'Staff Member Quick Information',
        }}
      />
                          ...
                          return (
                            ...
                            >
                              <Card.Section className="text-center p-4 pb-1 pt-12 rounded-tl-[15px] rounded-tr-[15px] bg-gradient-to-br from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 bg-opacity-40">
                                ...
                                <Box>
                                  <Text fw={700} size="lg" className="text-gray-800 dark:text-gray-100">{val.name}</Text>
                                </Box>
                                <Box>
                                  <Text size="sm" c="dimmed" className="mb-2">SNAH123658</Text>
                                </Box>
                              ...
                              <Card.Section className="p-4 space-y-3 bg-white-100 dark:bg-gray-900 bg-opacity-30 dark:bg-opacity-50">
                                ...
                                <Paper className="bg-pink-50 dark:bg-gray-800 p-4 rounded-lg border border-pink-200 dark:border-gray-700 h-fit">
                                  <Grid>
                                    <Grid.Col span={{ base: 12, sm: 6, md: 6 }}>
                                      <div className="flex justify-center flex-col">
                                        <Text size="sm" className="text-gray-600">Member Id</Text>
                                        <Text fw={500} className="text-xs">{val.memberId}</Text>
                                      </div>
                                    </Grid.Col>
                                    <Grid.Col span={{ base: 12, sm: 6, md: 6 }}>
                                      <div className="flex justify-center flex-col">
                                        <Text size="sm" className="text-gray-600">SSN</Text>
                                        <Text fw={500} className="text-xs">{val.ssn}</Text>
                                      </div>
                                    </Grid.Col>
                                    <Grid.Col span={{ base: 12, sm: 6, md: 6 }}>
                                      <div className="flex justify-center flex-col">
                                        <Text size="sm" className="text-gray-600">Plan Type</Text>
                                        <Text fw={500} className="text-xs">{val.planType}</Text>
                                      </div>
                                    </Grid.Col>
                                  </Grid>
                                </Paper>
                      ...
                      >
                        <Table.Thead>
                          <Table.Tr>
                            ...
                            <Table.Th className="text-center p-4 min-w-44">Other Info</Table.Th>
                            <Table.Th className="text-center p-4 min-w-44">Personal Info</Table.Th>
                            <Table.Th className="text-center p-4 min-w-80">Address</Table.Th>
                            <Table.Th className="text-center p-4 min-w-40">Status</Table.Th>
                                ...
                                <Table.Tr key={key} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                  <Table.Td className="p-4">
                                    <div className="flex items-center space-x-3">
                                      ...
                                      <div>
                                        ...
                                        <Text size="xs" c="dimmed">SNAH12365</Text>
                                      </div>
                                    </div>
                                  </Table.Td>
                                  <Table.Td className="p-4">
                                  ...
                                  <Table.Td className="p-4">
                                    <div className="flex flex-col">
                                      <Text size="sm"><b>Member Id: </b>{val.memberId}</Text>
                                      <Text size="sm"><b>SSN: </b>{val.ssn}</Text>
                                      <Text size="sm"><b>Plan Type: </b>{val.planType}</Text>
                                    </div>
                                  </Table.Td>
                                  <Table.Td className="p-4">
                                    <Text size="sm" c="dimmed">J98X+94 , Bethuadahari , West Bengal , 741126 , India</Text>
                                  </Table.Td>
                                  <Table.Td className="p-4">
                                    <Badge
                                      variant="light"
                                  ...
                                  <Table.Td className="p-4">
                                    <Group gap="xs">
                                      ...
                                      <Menu shadow="md"
                                        ...
                                        <Menu.Dropdown className="border border-gray-200 dark:border-gray-700 shadow-lg dark:bg-gray-800">
                                          <Menu.Label className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Staff Actions</Menu.Label>
                                          <Menu.Item leftSection={<IconInfoCircle size={16} />}
                                            ...
                                            onClick={() => handleDrawer(val)}
                                          >
                                            <Text size="sm" fw={500}>Staff Overview</Text>
                                          </Menu.Item>
                                          <Menu.Item leftSection={<IconDetails size={16} />}
                                            className="hover:bg-blue-50 dark:hover:bg-blue-900 transition-colors duration-200"
                                            onClick={() => navigateUrl({ data: val, type: "detail", url: 'detail' })}
                                          >
                                            <Text size="sm" fw={500}>Staff Details</Text>
                                          </Menu.Item>
                                        </Menu.Dropdown>
                                      </Menu>
                                    </Group>
